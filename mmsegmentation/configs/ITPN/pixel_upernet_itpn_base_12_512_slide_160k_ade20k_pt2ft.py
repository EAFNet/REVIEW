...
# --------------------------------------------------------'
# recommand use this config for BEiT models which are self-supervised pretrained and
# then intermediate fine-tuned on imagenet

_base_ = [
    '../_base_/models/upernet_beit.py', '../_base_/datasets/newdata.py',
