...
def parse_args():
    ...
    parser.add_argument(
        '--config',default='${/home/sdxx/桌面/mmsegmentation-master/swin_t/upernet_swin_tiny_patch4_window7_512x512_160k_ade20k_pretrain_224x224_1K.py}', type=str, nargs='+', help='ensemble config files path')
    parser.add_argument(
        '--checkpoint',
        type=str,
        nargs='+',
        default='${/home/sdxx/桌面/mmsegmentation-master/swin_t/iter_9000.pth}',
