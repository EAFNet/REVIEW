...
def parse_args():
    ...
    parser.add_argument(
        '--config', type=str, nargs='+', default='{/home/sdxx/桌面/mmsegmentation-master/convnext_ce/upernet_convnext_large_fp16_640x640_160k_ade20k.py}',help='ensemble config files path')
    parser.add_argument(
        '--checkpoint',
        type=str,
        nargs='+',
        default='{/home/sdxx/桌面/mmsegmentation-master/convnext_ce/iter_8000.pth}',
