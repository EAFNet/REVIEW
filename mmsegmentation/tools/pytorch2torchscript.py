...
def parse_args():
    ...
    parser.add_argument('config',default='{/home/sdxx/桌面/mmsegmentation-master/convnext_ce/upernet_convnext_large_fp16_640x640_160k_ade20k.py]', help='test config file path')
    parser.add_argument('--checkpoint',default='/home/sdxx/桌面/mmsegmentation-master/convnext_ce/iter_8000.pth', help='checkpoint file')
    parser.add_argument(
